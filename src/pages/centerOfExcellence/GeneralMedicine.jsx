    ...
    <PageContainer>
      <DiparmantContainer>
        <DepartmentHero
          breadcrumbs={[
            { label: "Home", href: "/" },
            { label: "General Medicine", href: null }
          ]}
          title="Your First Step Toward Better Health"
          subText="Comprehensive internal medicine care for all age groups — because every patient matters"
        />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
