    ...
    <PageContainer>
      <DiparmantContainer>
        <DepartmentHero
          breadcrumbs={[
            { label: "Home", href: "/" },
            { label: "Cardiology", href: null }
          ]}
          title="Advanced Cardiac Care You Can Trust"
          subText="Expert heart specialists delivering life-saving treatment with compassion and precision."
        />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
              ...
              <AnimatedSection delay="0.2s">
                <ServicesGrid>
                  <ServiceItem>
                    ...
                    <ServiceTitle>Cardiac Surgery</ServiceTitle>
                    <ServiceDesc>Advanced surgical procedures for heart conditions</ServiceDesc>
                  </ServiceItem>
                  <ServiceItem>
                    <ServiceIcon>📊</ServiceIcon>
                    <ServiceTitle>Diagnostic Tests</ServiceTitle>
                    <ServiceDesc>Comprehensive heart health assessments</ServiceDesc>
                  </ServiceItem>
                  <ServiceItem>
                    <ServiceIcon>⚡</ServiceIcon>
                    <ServiceTitle>Emergency Care</ServiceTitle>
                    <ServiceDesc>24/7 emergency cardiac services</ServiceDesc>
                  </ServiceItem>
                </ServicesGrid>
              </AnimatedSection>
            </ContentContainer>
