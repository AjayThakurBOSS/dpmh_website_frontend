    ...
    <PageContainer>
      ...
      <DiparmantContainer>
        <DepartmentHero
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "General Surgery", href: null }
            ]}
            title="Safe, Skilled, and Successful Surgeries"
            subText="Expert surgeons using advanced techniques for faster recovery and better outcomes."
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our General Surgery Specialists</SectionTitle>
