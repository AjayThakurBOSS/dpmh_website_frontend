...
import NeuroSurgeryComponent from '../../components/deparmentComponent/NeuroSurgeryComponent'
...
const NeuroSurgery = () => {
  ...
  return (
    <PageContainer>
       <MetaTags
          title="Best Neurology Care | Best Neuro Surgery | Expert Neurologists for Brain, Spine & Nerve Disorders | Dr Prabhat Memorial Hiramati Hospital, Rajendra Nagar, Patna"
      ...
      <DiparmantContainer>
            ...
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "Neuro Surgery", href: null }
            ]}
            title="Precision Neurosurgery, Trusted Expertise"
            subText="Advanced brain and spine surgeries performed with cutting-edge technology and expert care."
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Neuro Surgery Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Neurologist" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
