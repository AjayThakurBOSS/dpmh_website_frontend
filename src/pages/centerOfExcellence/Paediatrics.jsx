    ...
    <PageContainer>
      <DiparmantContainer>
       	<DepartmentHero
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "Paediatrics", href: null }
            ]}
            title="Caring Hands for Little Hearts"
            subText="Dedicated pediatric specialists ensuring healthy growth, care, and smiles for every child."
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Paediatrics Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Pediatrician" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
