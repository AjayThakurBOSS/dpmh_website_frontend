    ...
    <PageContainer>
      ...
      <DiparmantContainer>
       	 <DepartmentHero
              breadcrumbs={[
                { label: "Home", href: "/" },
                { label: "Urology", href: null }
              ]}
              title="Advanced Urology Care for Every Need"
              subText="Specialized diagnosis and treatment for kidney, bladder, and urinary tract disorders."
            />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Urology Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Urologist" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
