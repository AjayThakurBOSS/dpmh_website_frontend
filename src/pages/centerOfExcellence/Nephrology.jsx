  ...
  return (
    <PageContainer>
      ...
      <DiparmantContainer>
            ...
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "Nepherology", href: null }
            ]}
            title="Comprehensive Kidney Care for a Healthier Tomorrow"
            subText="From diagnosis to dialysis — expert nephrologists ensuring your kidney health stays in safe hands."
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
              <AnimatedSection delay="0.1s">
                 <NepherologyComponent/>
              </AnimatedSection>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Nephrology Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Nephrologist" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
