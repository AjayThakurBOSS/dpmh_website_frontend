    ...
    <PageContainer>
      ...
      <DiparmantContainer>
         <DepartmentHero
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "Emergency", href: null }
            ]}
            title="24×7 Emergency Care — Every Second Counts"
            subText="Immediate response, expert doctors, and advanced life support — always ready when you need us most"
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Emergency Care Specialists</SectionTitle>
