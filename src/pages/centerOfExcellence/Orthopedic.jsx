  ...
  return (
    <PageContainer>
      ...
      <DiparmantContainer>
            ...
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "Orthopedic", href: null }
            ]}
            title="World Class facilities to handle all type of Heart Conditions."
            subText="We have great team of specialised doctor, on that you can trust, for you heart."
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Orthopedic Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Orthopedic Surgeon" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
