    ...
    <PageContainer>
      ...
      <DiparmantContainer>
       	  <DepartmentHero
              breadcrumbs={[
                { label: "Home", href: "/" },
                { label: "Gynecology", href: null }
              ]}
              title="Caring for Women’s Health at Every Stage of Life"
              subText="Safe, supportive, and specialized gynecological care — from adolescence to motherhood and beyond."
            />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Gynecology Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Gyneologist / Obstetrician" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
