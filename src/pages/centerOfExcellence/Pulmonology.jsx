    ...
    <PageContainer>
      ...
      <DiparmantContainer>
        <DepartmentHero
            breadcrumbs={[
              { label: "Home", href: "/" },
              { label: "Pulmonology", href: null }
            ]}
            title="Breathe Better, Live Better."
            subText="Comprehensive respiratory care for asthma, COPD, and all lung-related conditions."
          />
        <DepartmentBody>
          <MainContentWrapper>
            <ContentContainer>
          ...
          <RelatedDoctorsDiv>
            <AnimatedSection delay="0.6s">
              <SectionTitle>Our Pulmonology Specialists</SectionTitle>
             <EachDeparmentDoctor specialization="Pulmonologist (Chest Specialist)" />
            </AnimatedSection>
          </RelatedDoctorsDiv>
        </DepartmentBody>
      </DiparmantContainer>
