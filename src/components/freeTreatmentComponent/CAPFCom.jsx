...
const CAPFCom = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "CAPF is a comprehensive health insurance scheme for Central Armed Police Forces personnel and their families, providing cashless treatment up to ₹5 lakh per family per year.",
    },
    {
      question: "Who is eligible for CAPF?",
      answer:
        "All serving and retired CAPF personnel (BSF, CRPF, CISF, SSB, ITBP, AR, NSG) and their dependent family members are eligible for the scheme.",
    },
    {
      question: "What medical treatments are covered?",
      answer:
        "The scheme covers 1,393 medical packages including surgery, medical treatments, day care procedures, pre-existing conditions, and all types of critical illnesses.",
    },
    {
      question: "How to avail cashless treatment?",
      answer:
        "Present your CAPF e-card at any empaneled hospital. The hospital will verify eligibility and provide cashless treatment after pre-authorization.",
    },
    {
      question: "Are retired CAPF personnel covered?",
      answer:
        "Yes, retired CAPF personnel and their families are covered for lifetime under the scheme. They need to register and obtain their CAPF e-card.",
    },
    {
      question: "What documents are required for registration?",
      answer:
        "Service certificate, Aadhaar card, family details, photographs, and dependent certificates are required for registration under CAPF.",
    },
    {
      question: "Is there any co-payment or hidden costs?",
      answer:
        "No, the treatment is completely cashless and paperless. There are no registration fees, co-payments, or hidden costs for the beneficiaries.",
    },
    {
      question: "Can we get treatment in any city?",
      answer:
        "Yes, treatment can be availed at any empaneled hospital across India, making it especially beneficial for personnel posted in different locations.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <MetaTags
        title="  CAPF Health Scheme | Cashless Treatment for CAPF Personnel & Families | DPMH Hospital Patna | Dr Prabhat Memorial Hiramati Hospital, Rajendra Nagar, Patna"
        description="Get cashless treatment up to ₹5 Lakh under the CAPF Health Scheme at Dr. Prabhat Memorial Hiramati Hospital, Patna. Serving & retired CAPF personnel and families covered."
        keywords="CAPF Hospital in Patna, Cashless treatment for CAPF, CAPF Ayushman Scheme, CAPF empaneled hospital Patna, CAPF health benefits, CAPF e-card treatment, Hospital for CRPF, BSF, CISF, SSB, ITBP, Assam Rifles, CAPF medical services in Patna, CAPF free treatment, Best hospital for CAPF in Patna, Ayushman Bharat CAPF scheme, CA0PF cashless surgery Patna"
        type="website"
      />
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              ...
              <p className="text-base md:text-lg mb-6 md:mb-8 opacity-80 leading-relaxed">
                A dedicated healthcare scheme for Central Armed Police Forces
                personnel and their families, ensuring cashless medical
                treatment across India.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                <a href="tel:84060000555">
                  <button
                    className="bg-[#004AAD] text-[#fff] px-4 py-3 md:px-6 md:py-3 rounded-lg font-semibold hover:bg-gray-100 hover:text-[#004aad] transition duration-300 flex items-center justify-center w-full sm:w-auto"
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
            <div>
              <p className="text-base md:text-lg text-gray-600 mb-4 md:mb-6 leading-relaxed">
                CAPF is a specialized health insurance scheme launched to
                provide comprehensive healthcare coverage to personnel of
                Central Armed Police Forces and their families. It ensures our
                brave personnel receive quality medical care without financial
                worries.
              </p>
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-blue-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700 text-sm md:text-base">
                    Coverage for serving and retired personnel
                  </span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-blue-500 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <Container>
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 mt-3 md:mt-4 max-w-2xl mx-auto text-sm md:text-base">
              All Central Armed Police Forces personnel and their families are
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {services.map((service, index) => (
              ...
              >
                <div className="flex items-start mb-3 md:mb-4">
                  <div
                    className="p-2 rounded-lg mr-3 md:mr-4"
              ...
              <ul className="space-y-2 md:space-y-3 text-gray-600">
                <li className="flex items-start">
                  ...
                  <span className="text-sm md:text-base">
                    Serving CAPF personnel (all ranks)
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-sm md:text-base">
                    Retired CAPF personnel and families
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-sm md:text-base">
                    Dependent parents of personnel
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-sm md:text-base">
                    Coverage across all states in India
                  </span>
                </li>
              </ul>
            </Card>
      ...
      <section className="py-12 md:py-16 bg-white">
        <Container>
          <div className="text-center mb-8 md:mb-12">
            ...
            <div className="w-20 h-1 bg-blue-600 mx-auto"></div>
            <p className="text-gray-600 mt-3 md:mt-4 max-w-2xl mx-auto text-sm md:text-base">
              Simple and streamlined process for our forces to access healthcare
              services
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
            <Card className="p-4 md:p-6 text-center">
              ...
              <p className="text-gray-600 text-xs md:text-sm">
                Special helpline for CAPF personnel
              </p>
            </Card>
            ...
            <Card className="p-4 md:p-6 text-center">
              ...
              <p className="text-gray-600 text-xs md:text-sm">
                Priority processing for forces
              </p>
            </Card>
            ...
            <Card className="p-4 md:p-6 text-center">
              ...
              <p className="text-gray-600 text-xs md:text-sm">
                Treatment during postings anywhere
              </p>
            </Card>
